...
elseif ffi.os == "OSX" then -- MacOS
  libpath = "cimgui.dylib"
else -- Linux
  -- libpath = script_dir .. "/lib/cimgui/cimgui.so"
  libpath = "cimgui.so"
end
...
-- Expose the C library to other files
M.C = C
M.lib = C   -- Some bindings look for .lib

-- wrap.lua uses this to cache textures and callbacks
M._common = {
    textures = {},
    callbacks = {}
}
-- Required by shortcuts
M.IsWindowFocused = function(flags) return false end
